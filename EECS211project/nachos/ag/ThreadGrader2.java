...
{ 
  ...
  { 
    ...
    System.out.println("Test ThreadGrader2.a: Tests your communicator");
    total = 1; 
    count = 0; 
    list.clear(); 
     ...
     * speakers/listeners 
     */ 
    System.out.println("Test ThreadGrader2.b: Tests your communicator, with more \r\n" + 
    		"     * speakers/listeners");
    total = 2; 
    count = 0; 
    forkNewThread(new a(111)); 
     ...
     * speakers/listneers, and transmits more messages 
     */ 
    System.out.println("Test ThreadGrader2.c: Tests your communicator, with more \r\n" + 
    		"     * speakers/listneers, and transmits more messagesr");
    total = 50; 
    count = 0; 
    int na = 0, nb = 0; 
