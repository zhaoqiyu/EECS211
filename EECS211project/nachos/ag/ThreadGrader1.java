...
{ 
  ...
  { 
     ...
     */ 
    System.out.println("Test ThreadGrader1.a: Tests your condition variables using a few threads");
    total = 4; 
    count = 0; 
     ...
     */ 
    System.out.println("Test ThreadGrader1.b: Tests your condition variables using many threads");
    total = 100; 
    count = 0; 
    turn = Lib.random(total); 
